...
for name, v in [
    ...
    # v6.2 additions
    ("difference direction defined", "comparator minus the selection procedure"),
...
for name, v in [
    ...
    # mentor revision round 1 (2026-09-14)
    ("new title", "Leakage-Safe, Calibrated Electronic Health Record Model"),
    # critical-review round (2026-09-14 overnight)
    ("timing subsection", "Readmission Timing and Subgroup Performance"),
    ("Graham ref", "early and late readmissions"),
    ("Krumholz ref", "Post-hospital syndrome"),
    ("Seyyed-Kalantari ref", "Underdiagnosis bias"),
    ("Blanche ref", "censored event times with competing risks"),
    ("leakage-safe scoped", "leakage-safe denotes this design"),
    ("payer scope stated", "carried non-Medicare insurance"),
    ("era sensitivity", "anchor_year_group era band"),
    ("sample size stated", "events-per-candidate ratio"),
    ("multiplicity stated", "no adjustment for multiple comparisons"),
    ("cause-specific tdAUC", "remain in the "),
    ("age-band gap quantified", "0.7542"),
    ("Black AUROC 4dp", "0.7375"),
    ("threshold equity", "share of nonreadmitted Black patients"),
    ("within-system label bias", "differential outcome misclassification"),
    ("death nonevent caveat", "must not be "),
    ("appendix 5 cited", "Multimedia Appendix 5"),
    ("design subtitle kept", "Retrospective Development and Internal Validation"),
    ("Related Work section", "Related Work"),
    ("leakage pitfalls subsection", "Data Leakage and Validation Pitfalls"),
    ("Study Rationale section", "The gap, therefore, is not another"),
    ("four RQs", "Four research questions organize the study"),
    ("RQ4 answered", "RQ4 (timing and subgroups)"),
    ("Kapoor ref", "Kapoor S, Narayanan A"),
    ("Futoma ref", "The myth of"),
    ("Wiens ref", "Do no harm"),
    ("keyword data leakage", "data leakage; calibration"),
]:
    ok &= check(name, v)
for name, v in [
    ("Appendix figure unnumbered", "(Multimedia Appendix figure)"),
    # mentor revision round 1: superseded framings must be gone
    ("old prior-work heading gone", "Prior Work on MIMIC-IV and Study Rationale"),
    # review round: superseded wordings must be gone
    ("age-stability claim gone", "stable across age bands"),
    ("four-findings label gone", "Four findings carry the study"),
    ("STROBE label gone", "STROBE-style"),
    ("re-implemented gone", "re-implemented"),
    ("RFE-procedure naming gone", "the RFE procedure"),
    ("ECE deciles wording gone", "error over deciles"),
    ("dual python claim gone", "Python 3.11 and 3.12"),
    ("funding heading gone", "Funding Statement"),
    ("adapted-scores naming gone", "adapted"),
    ("old RQ2 framing gone", "best modeling approach"),
    ("old three-RQ framing gone", "Three research questions"),
    ("HER typo absent", "HER features"),
