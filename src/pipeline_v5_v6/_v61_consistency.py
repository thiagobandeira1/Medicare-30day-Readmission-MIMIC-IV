...
doc = Document(str(PUB / "Paper JMIR AI Submission v6.1.docx"))
...
for name, v in [
    ("procedure described as 27-38 features", "27-38"),
    ("bootstrap scope disclosed", "were not repeated within bootstrap samples"),
    ("indirect-influence disclosure", "residual indirect influence"),
    ("consensus set optimism note", "potentially optimistic"),
...
out = PUB / "CONSISTENCY_REPORT_V6.1.md"
out.write_text("# v6.1 value-level consistency report\n\n"
