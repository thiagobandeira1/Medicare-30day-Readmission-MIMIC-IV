...
SP("LACE [3]: length-of-stay points per the original bands; 3 acuity "
   ...
   "An earlier development-phase variant used a 6-month prior-admission "
   "proxy and is retained only as a sensitivity result. Full mappings "
...
SP("The competing-risks event process was built from patients.dod, "
   ...
   "as the linear reference, with competing deaths censored at their "
