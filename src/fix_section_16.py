...
4. **Quantification of the parsimony frontier** at the top-50-by-importance subset: §10.4 shows the 50-feature model retains the bulk of the 90-feature working-set signal (Δ test AUROC ≈ −0.0005, within seed-level noise), empirically validating the capstone's parsimony claim under the strict 80/20 + inner-val protocol.
